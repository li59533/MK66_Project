 ...
 * @{  
 */
#define E32_M0_UP  		GPIO_WritePinOutput(GPIOE, 0, 1)
#define E32_M0_DOWN  	GPIO_WritePinOutput(GPIOE, 0, 0)
...
static void bsp_e32_halinit(void)
{
	...
	GPIO_PinInit(GPIOE, 0, &gpio_pin_config);
	...
	GPIO_WritePinOutput(GPIOE, 0, 1); // M0
